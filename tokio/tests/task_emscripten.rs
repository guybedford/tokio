//! Synchronous regression tests for emscripten-specific behavior that does
//! not require driving the executor. Async behavior is covered in
//! `task_emscripten_async.rs`, `task_emscripten_api.rs`, and
//! `task_emscripten_contracts.rs`.
